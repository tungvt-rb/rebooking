...
<div class="wrapper content">
	...
	<div class="g-row">
		<div class="full-width"><?php if( function_exists( 'kmf_breadcrumbs' ) ) kmf_breadcrumbs(); ?></div>
		<div class="clear"></div>

		<div class="two-thirds">
			<div class="tpc">
				<div class="tpc-header mrg-btm">
					<div class="two-thirds no-pad">
						<h1><?php echo $term->name ?></h1>
						<p><?php echo $term->description; ?></p>
					</div>
					<div class="one-third no-pad">
						<?php $meta_image = ( function_exists( 'get_wp_term_image' ) ) ? get_wp_term_image( $term->term_id ) : ''; ?>
